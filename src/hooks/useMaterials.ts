...
const sampleMaterials: Material[] = [
  {
    ...
    status: 'available',
    barcode: 'SB001',
    gridPosition: { row: 1, col: 1, areaId: 'area-1' },
  ...
  },
  {
    ...
    status: 'reserved',
    barcode: 'CB002',
    gridPosition: { row: 2, col: 3, areaId: 'area-1' },
  ...
  },
  {
    ...
    status: 'in-use',
    barcode: 'WM003',
    gridPosition: { row: 0, col: 5, areaId: 'area-1' },
  ...
  },
  {
    ...
    status: 'available',
    barcode: 'AP004',
    gridPosition: { row: 3, col: 0, areaId: 'area-1' },
    properties: { thickness: '3mm', finish: 'Anodized' },
    color: '#6366F1',
    size: { width: 70, height: 50 },
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    status: 'reserved',
    barcode: 'IR005',
    gridPosition: { row: 4, col: 2, areaId: 'area-1' },
    properties: { 'R-value': 'R-30', width: '24in' },
    color: '#8B5CF6',
    size: { width: 70, height: 50 },
    createdAt: new Date(),
    updatedAt: new Date()
